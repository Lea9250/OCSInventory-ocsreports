              ...
              echo $translationSearch->getTranslationFor($table)." : ".$translationSearch->getTranslationFor($values['fields']);
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<?php 	if((strpos($values['fields'], 'fields_') !== false) || ($values['fields'] == "CATEGORY_ID") || ($values['fields'] == 'CATEGORY') || (($search->getSearchedFieldType($table, $values['fields']) == 'datetime')) || (($search->getSearchedFieldType($table, $values['fields']) == 'date'))) {
									error_log("DATE OR DATETIME");
